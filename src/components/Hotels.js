...
const Hotels = () =>  {
  ...
  const getHotels = async () => {
      const response = await axios.get('https://supreme-goggles-beta.vercel.app/api/v1/getHotel');
...
<NavLink className="m-1 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 
        font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-5 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" to="/addhotel">
                Add Hotel
            </NavLink>
            </div>
